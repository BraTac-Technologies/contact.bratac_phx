defmodule ContactBratac.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ContactBratac.Repo)
  ...
  """
  def valid_password?(%ContactBratac.Accounts.Admin{hashed_password: hashed_password}, password)
