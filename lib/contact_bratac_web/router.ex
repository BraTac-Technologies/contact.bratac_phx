defmodule ContactBratacWeb.Router do
  use ContactBratacWeb, :router

  import ContactBratacWeb.AdminAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {ContactBratacWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ContactBratacWeb.Telemetry
    end
  end
