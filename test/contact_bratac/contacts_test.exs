defmodule ContactBratac.ContactsTest do
  use ContactBratac.DataCase
  ...
  describe "contacts" do
    ...
    test "create_contact/1 with valid data creates a contact" do
      valid_attrs = %{email: "some email", first_name: "some first_name", last_name: "some last_name", message: "some message", phone: "some phone", subject: "some subject"}
    ...
    test "update_contact/2 with valid data updates the contact" do
      ...
      assert contact.subject == "some updated subject"
    end
