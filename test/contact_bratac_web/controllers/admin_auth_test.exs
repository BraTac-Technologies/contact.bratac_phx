defmodule ContactBratacWeb.AdminAuthTest do
  use ContactBratacWeb.ConnCase, async: true

  alias ContactBratac.Accounts
  alias ContactBratacWeb.AdminAuth
  import ContactBratac.AccountsFixtures

  @remember_me_cookie "_contact_bratac_web_admin_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ContactBratacWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ContactBratacWeb.Endpoint.subscribe(live_socket_id)
